...
/**
 * <p>
 * <b>{@link ValidateColetaTask}</b>
 * </p>
 * <p>
 * <p>
 * Async Task para Verificar ser donativo está valido para ser coletado.
 * </p>
 *
 * @author <a href="https://github.com/JoseRafael97">Rafael Feitosa</a>
 */
public class ValidateColetaTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public ValidateColetaTask(Context context, Long id) {
        this.id = id;
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            return donativoRemoteService.isValidColetaByDonativo(id);
