...
/**
 * <p>
 * <b>{@link ValidateCancelDonativoTask}</b>
 * </p>
 * <p>
 * <p>
 * Async Task para Verificar ser donativo está valido para ser cancelado.
 * </p>
 *
 * @author <a href="https://github.com/JoseRafael97">Rafael Feitosa</a>
 */
public class ValidateCancelDonativoTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public ValidateCancelDonativoTask(Context context, Long id) {
        this.id = id;
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            return donativoRemoteService.isValidCancelamentoByDonativo(id);
